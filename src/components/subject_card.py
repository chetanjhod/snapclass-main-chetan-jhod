...
def subject_card(name, code, section, stats=None, footer_callback=None):
    ...
    <div style="background:white;border-left:8px solid #EB459E;padding:25px;border-radius:20px;border:1px solid black;margin-bottom:20px;">
        <h3 style="margin:0;color:#111111;font-size:1.5rem;">{name}</h3>

        <p style="color:#111111;margin:10px 0;">
            Code :
    ...
    if stats:
        ...
        for icon, label, value in stats:
            html += f"""
            <div style="background:#EB459E10;padding:5px 12px;border-radius:12px;font-size:0.9rem;color:#111111;">
