...
from src.pipelinens.voice_pipeline import process_bulk_audio
    ...
    if st.button('Analyze Audio', width='stretch', type='primary'):
        with st.spinner('Processing Audio data'):
            ...
            for node in enrolled_students:
                ...
                results.append({"Name": student['name'],"ID": student['student_id'],"Source": score if is_present else "_","Status": "✅ Present" if is_present else "❌ Absent"})
